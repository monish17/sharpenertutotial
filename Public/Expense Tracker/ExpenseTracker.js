...
function onSubmit(e){
    e.preventDefault();
        ...
        console.log(myobj);
        axios.post(`http://${config.PORT_ADDRESS}:3000/routes/PostData`,myobj,{headers:{'Authorization':Token}})
            .then((Response)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    axios.get(`http://${config.PORT_ADDRESS}:3000/routes/retrieveData?page=`+page+ "&pageLimit=" + pageLimit,{headers:{'Authorization':Token}})
        .then((response)=>{
...
function deleteclick(e){
    ...
    if (li) {
        ...
        axios.delete(`http://${config.PORT_ADDRESS}:3000/routes/deleteData/${hiddenIdValue}`,{headers:{'Authorization':Token},data:{ expenseAmount: spanTextContent,type:DataType.value}})
            .then(response =>{
                console.log(response)
...
function UpdateExpense(){
    axios.get(`http://${config.PORT_ADDRESS}:3000/routes/getTotalTransaction`,{headers:{'Authorization':Token}})
        .then((response)=>{
...
document.getElementById('rzp-button').onclick = async function(e){
    ...
    const response=await axios.get(`http://${config.PORT_ADDRESS}:3000/purchase/premiummembership`,{headers:{'Authorization':Token}});
    //console.log(response);
    var options={
        ...
        "handler":async function(response){
            console.log(response);
            await axios.post(`http://${config.PORT_ADDRESS}:3000/purchase/updateTransactionStatus`,{
    ...
    rzpl.on('payment.failed',function(response){
        ...
        axios.post(`http://${config.PORT_ADDRESS}:3000/purchase/updateTransactionStatus`,{
...
function leaderBoardFunction(){
    ...
    axios.get(`http://${config.PORT_ADDRESS}:3000/premium/leadershipBoard`,{headers:{'Authorization':Token}}).then((response)=>{
...
function downloadFile(){
    ...
    axios.get(`http://${config.PORT_ADDRESS}:3000/routes/download`, { headers: {"Authorization" : Token} })
    .then((response) => {
        console.log(response);
...
function downloadReport(){
    ...
    axios.get(`http://${config.PORT_ADDRESS}:3000/routes/retrieveExpenseReport`,{headers:{'Authorization':Token}})
        .then((response)=>{
...
function downloadReportHistory(){
    ...
    axios.get(`http://${config.PORT_ADDRESS}:3000/routes/DownloadsHistory`,{headers:{'Authorization':Token}})
    .then((response)=>{
        console.log(response);
